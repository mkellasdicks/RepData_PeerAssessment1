---
title: "Course 5 - Peer Assignment 1"
author: "MKD"
...
Mean Number of Steps per Day: `r meanSteps1`.  
...
Mean Number of Steps per Day: `r meanSteps2`.  
Median Number of Steps per Day: `r medianSteps2`.
...
Mean Number of Steps per Day (NA removed): `r meanSteps1`.  
Median Number of Steps per Day (NA removed): `r medianSteps1`.
...
##5. Pattern Differences - Weekdays vs. Weekends
...
# dimensions:
# Height = 14.0 - this is 14 inches, 2 * the default of 7 inches. Values: Numeric, with decimal!
